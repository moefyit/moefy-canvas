<!-- based on https://github.com/vuepress/vuepress-community/blob/main/packages/docs/src/.vuepress/components/GitHubLink.vue -->
...
const link = computed(() =>
  props.subpath
    ? `https://github.com/${props.repo}/tree/main/${props.subpath}`
    : `https://github.com/${props.repo}`
)
</script>
...
<template>
  <a class="github-link" rel="noopener noreferrer" target="_blank" :title="repo" :href="link">
